...
```
### The corrolation between No2 and the independent variables can be seen in the above matrix.From the plots it can be seen that the linear relationship exist between the dependent and independent variables.
...
### Seems gtreat! based on the model that we have now, we can say that the following variables play a significant role in explaining the NO2 for the period of mid marrch to mid april for the year 2020.
...
#### Now, we can talk about the result of model 4 as our final model for year 2020. We have a good evidence that all the remaining variables have impact on the model as the p values are small. Also, we met all the linear model condition along the way.
...
importance(rf_model_2020)
varImpPlot(rf_model_2020)
...
### Seems gtreat! based on the model that we have now, we can say that the following variables play a significant role in explaining the NO2 for the period of mid marrch to mid april for the year 2022.
...
# View variable importance
importance(rf_model_2022)
varImpPlot(rf_model_2022)
